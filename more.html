                        ...
                        <nav role="navigation" class="col-xs-12 col-sm-10 col-md-10 col-lg-10 navbar navbar-default">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">            
                                ...
                                <ul class="nav navbar-nav">			          
                                    ...
                                    <li><a href="#section-one" title="Overview">About Us</a></li>

                                    <li><a href="#section-two" title="Features">Cockatiel Introduction</a></li>

                                    <li><a href="#section-three" title="Pricing">Male /Female</a></li>
            ...
            <!-- banner Text --> 
                 ...
                 <section class="text-center">
                    ...
                    <h2>Company name Here</h2>
                     ...
                     <a class="popup-vimeo video-button" href="https://youtu.be/QGMpYe6uVNg"><i class="fa fa-caret-right" aria-hidden="true"></i></a>
